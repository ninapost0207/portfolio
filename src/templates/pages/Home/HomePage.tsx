            ...
            <div className='home-page container'>
                <div className='home-page__content'>
                    ...
                    <div className='home-page__icons-block flex flex-row justify-between  align-center'>
                        <a href="https://github.com/ninapost0207" target='blank' className='home-page__icons-block__item' aria-label="gitHub">
                            <img src={gitHub} alt="gitHub" className='home-page__icon' />
                        </a>
                        <a href="www.linkedin.com/in/nina-postnikova-505829241" target='blank' className='home-page__icons-block__item' aria-label="linkedIn">
                            <img src={linkedIn} alt="linkedIn" className='home-page__icon' />
                        </a>
                        <a href="https://www.facebook.com/profile.php?id=100094232073336&mibextid=ZbWKwL" target='blank' className='home-page__icons-block__item' aria-label="facebook">
