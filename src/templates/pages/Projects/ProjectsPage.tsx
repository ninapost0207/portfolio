...
export default function Projects() {
        ...
        {dataReversed.map((project) => {
            return (
                <div className="sidebar__item" key={project.header}>
                    <a href={project.href} target="_blank" rel="noreferrer" area-label="To the Website">
    ...
    const rightSlide = <div className="main-slide" style={{ bottom: `${100 * (activeSlide)}%` }} onScroll={e => handleScroll(e)}>
        ...
        <a href="#top" className={`main-slide__scroll-button ${showScrollButton ? "" : "hidden"}`} area-label="To the Top of the Page">
